...
<head>
	...
	<!-- Meta tag Keywords -->
	<meta name="viewport" content="width=device-width, iUCOEial-scale=1">
	<meta charset="utf-8">
	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php">UCOE <span class="display"></span></a></h1>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://UCOE.ac.in" target="_blank">UCOE <span class="display"> KAMAN</span></a>
		</div>
   ...
   if(isset($_POST['submit'])){
     ...
     if($row = mysqli_fetch_assoc($result)){
        ...
        if($pwdCheck == false){
            ...
            echo $hostel_id;
            $number = 1;
            $query12 = "INSERT INTO application (Student_id,Hostel_id,Application_status,Message) VALUES ('$roll','$hostel_id','$number','$message')";
            $result3 = mysqli_query($conn,$query12);
            if($result3){
