...
<head>
	...
	<meta charset="utf-8">
	<meta name="keywords" content="UCOE Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template,
	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home.php"><span class="display"> UCOE </span></a></h1>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="index.html"><span class="display"> UCOE</span></a>
		</div>
		<div class="footer-grid">
			...
			<div class="agileits_w3layouts-copyright mt-4 text-center">
				<p>© 2018 UCOE. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="=_blank"> W3layouts </a></p>
		</div>
		</div>
	</div>
</footer>
